...
The 'dbx_prof_exam_prep' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dbx_prof_exam_prep/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_prof_exam_prep_etl` to your workspace.
